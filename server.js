...
const castSeed = [
  ...
  ['Joe Hunter',                 'Cila', 46, 'West Sacramento, CA', '',                          'Fire captain',               1, null],
  ...
  ['Savannah Louie',             'Cila', 31, 'Atlanta, GA',         '',                          'Marketing specialist',       0,    2],
  ['Jenna Lewis-Dougherty',      'Cila', 47, 'Woodland, CA',        'Jenna_Lewis_(Survivor)',    'Realtor',                    0,    1],
  // KALO TRIBE (Teal)
  ['Charlie Davis',              'Kalo', 27, 'Boston, MA',          '',                          'Attorney',                   1, null],
  ...
  ['Jonathan Young',             'Kalo', 32, 'Gulf Shores, AL',     '',                          'Beach service owner',        1, null],
  ['Kamilla Karthigesu',         'Kalo', 31, 'Foster City, CA',     '',                          'Software engineer',          1, null],
  ['Mike White',                 'Kalo', 54, 'Hanalei, HI',         'Mike_White_(filmmaker)',    'Writer/director',            1, null],
  ['Tiffany Nicole Ervin',       'Kalo', 34, 'Los Angeles, CA',     '',                          'Artist/Creative producer',   1, null],
